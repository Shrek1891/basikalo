...
import {setSelectedUser, setUsers} from "../features/chat/chatSlice";
import {useEffect, useState} from "react";
import {removeOnlineUser} from "../features/user/userSlice.ts";
...
const Sidebar = () => {
    ...
    useEffect(() => {
        socket?.on("removeOnlineUser", (userId: string) => {
